...
module.exports = {
  identityApotheke: {
    ...
    cert:
    {
      version: 2,
      subject: {
        commonName: 'Adler Apotheke',
        countryName: 'DE',
        stateOrProvinceName: 'NRW',
        organizationName: 'mainorg.health-ledger.de',
        organizationalUnitName: 'Apotheke'
      },
      issuer: {
        countryName: 'DE',
        stateOrProvinceName: 'NRW',
    ...
    attrs: {},
    id: 'x509::/CN=Hans MÃÂ¼ller/C=DE/ST=NRW/O=mainorg.health-ledger.de/OU=Apotheke::/C=DE/ST=NRW/L=Bielefeld/O=mainorg.health-ledger.de/CN=ca.mainorg.health-ledger.de'
  },
